      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @endif
            @if ($x)
            <a class="btn btn-outline-light btn-social mx-1" target="_blank" href="{{ $x }}"><i class="fab fa-fw fa-twitter"></i></a>
            @endif
            @if ($facebook)
            <a class="btn btn-outline-light btn-social mx-1" target="_blank" href="{{ $facebook }}"><i class="fab fa-fw fa-facebook-f"></i></a>
            @endif
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  <!-- Partner Modal - Text-->
                  <p class="mb-4">{!! strip_tags($item->content) !!}</p>
                  <div class="mb-5">
